...
#writer = SummaryWriter('runs/train_experiment')
...
from vision.datasets.voc_dataset_new import VOCDataset
...
def train(loader, net, criterion, optimizer, device, debug_steps=100, epoch=-1):
    ...
    for i, data in enumerate(loader):
        ...
        if i and i % debug_steps == 0:
          ...
          #  writer.add_scalar('regression_loss',regression_loss ,epoch * len(loader) + i)  
         #   writer.add_scalar('classification_loss',classification_loss ,epoch * len(loader) + i)
         #   writer.add_scalar('Total_Loss',loss ,         epoch * len(loader) + i)                                                
            running_loss = 0.0
            running_regression_loss = 0.0
            running_classification_loss = 0.0
        #    writer.close()
